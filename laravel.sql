...
CREATE TABLE `cv` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cv_user_id_foreign` (`user_id`),
  KEY `cv_job_type_id_foreign` (`job_type_id`),
  KEY `cv_category_id_foreign` (`category_id`),
  CONSTRAINT `cv_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cv_job_type_id_foreign` FOREIGN KEY (`job_type_id`) REFERENCES `job_types` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cv_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_reset_tokens_table',1),(3,'2019_08_19_000000_create_failed_jobs_table',1),(4,'2019_12_14_000001_create_personal_access_tokens_table',1),(5,'2024_06_10_174054_add_role_to_users_table',1),(6,'2024_06_11_110840_create_categories_table',1),(7,'2024_06_12_140246_create_job_types_table',1),(8,'2024_06_12_140332_create_jobs_table',1),(9,'2024_06_16_020800_create_cv_table',1),(10,'2024_06_17_023157_create_cache_table',1),(11,'2024_06_17_134455_alter_jobs_table',1),(12,'2024_06_17_150757_create_job_applications_table',1),(13,'2024_06_17_155059_create_saved_jobs_table',1),(14,'2024_06_19_151210_modify_status_column_in_job_applications_table',1),(15,'2024_06_20_034519_add_cv_updated_to_users_table',1);
...
CREATE TABLE `users` (
  ...
  `cv_updated` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'Phan Huy Duong','huyduongphan8@gmail.com',NULL,'$2y$12$zae6s8kDg5ZIVl95Y16Ms.nJ1XIoh8heGTvGeJkds3p3f3o8cE/LO',NULL,'2025-02-25 17:05:38','2025-02-25 17:05:38','admin',0);
...
-- Dump completed on 2025-02-25 17:40:18
